...
concludes at any attempt; presence requires the WHOLE window — every observation well-formed,
identity-matched and in a standing status from the documented closed enum, a deletion glimpsed
mid-window never erased by a calm final read — and everything else is unknown. A set proven absent is recorded in
