...
- `0003-monorepo-github-actions-and-aws-cdk.md` - Pilot delivery decision: keep a monorepo, split delivery lanes with GitHub Actions, and use AWS CDK v2 for AWS IaC.
